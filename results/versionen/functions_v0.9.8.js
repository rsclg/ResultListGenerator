	...
	else if (xml != null && xml.length > 0)
	{
		if (document.getElementById("sendDialog") == null) {
			...
			
			{
				...
				userLabel.appendChild(document.createTextNode("Name *"));
				...
				eventTypeLabel.appendChild(document.createTextNode("Veranstaltungsart *"));
				...
				var completenessLabel = document.createElement("div");
				completenessLabel.style.fontStyle = "italic";
				completenessLabel.style.paddingTop = "10px";
				completenessLabel.style.textAlign = "center";
				{
					var completenessCheckbox = document.createElement("input");
					completenessCheckbox.type = "checkbox";
					completenessCheckbox.id = "completenessCheckbox";
					completenessLabel.appendChild(completenessCheckbox);
					
					var completenessText = document.createElement("label");
					completenessText.setAttribute("for", "completenessCheckbox");
					completenessCheckbox.style.marginLeft = "5px";
					completenessText.appendChild(document.createTextNode("Ja, die Ergebnismeldung ist vollständig."));
					completenessLabel.appendChild(completenessText);
				}
				input.appendChild(completenessLabel);
...
function sendResults(xml) {
	if (document.getElementById("userSelect").selectedIndex > 0 && 
		...
		document.getElementById("completenessCheckbox").checked) {
...
function addCompetition() {
	...
	competitionMasterSelect.title = "Vorlagenauswahl für den Wettbewerbsnamen, kann dann noch angepasst werden";
